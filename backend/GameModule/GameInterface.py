...
from GameModule.Rounds import BackgroundPicture, Round
...
class Game(ABC):
    ...
    # subject to change but I'm pretty sure we should have a ref to each round collection based on difficulty.
    @abstractmethod
